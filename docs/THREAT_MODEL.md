...
The current OpenMLS dependency (0.5.x) pulls in curve25519-dalek and ed25519-dalek versions with known CVEs. Upgrade to OpenMLS 0.8.x is required before production deployment.
