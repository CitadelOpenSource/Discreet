...
import { T } from '../theme';
import { User, Mail, Check, Zap, Building2, Landmark } from '../icons';
...
export const TIER_META: Record<Tier, TierMeta> = {
  guest: {
    label:   'Guest',
    icon:    React.createElement(User, { s: 16 }),
    color:   '#6b7280',
    tagline: 'No account',
    price:   'Free',
  ...
  unverified: {
    label:   'Unverified',
    icon:    React.createElement(Mail, { s: 16 }),
    color:   '#f59e0b',
  ...
  verified: {
    label:   'Verified',
    icon:    React.createElement(Check, { s: 16 }),
    color:   '#10b981',
  ...
  pro: {
    label:   'Pro',
    icon:    React.createElement(Zap, { s: 16 }),
    color:   '#6366f1',
  ...
  teams: {
    label:   'Teams',
    icon:    React.createElement(Building2, { s: 16 }),
    color:   '#3b82f6',
  ...
  enterprise: {
    label:   'Enterprise',
    icon:    React.createElement(Landmark, { s: 16 }),
    color:   '#f59e0b',
      ...
      React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 3, marginBottom: 10 } },
        ...newPerks.map(perk =>
          React.createElement('div', {
            ...
            React.createElement(Check, { s: 12 }),
            perk,
          ),
        ),
      ),
