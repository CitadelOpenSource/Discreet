...
import {
  ...
  ClipboardList as LClipboard,
  BookOpen as LBookOpen,
  ChevronLeft as LChevL,
  Palette as LPalette,
  Mail as LMail,
...
export const Phone = w(LPhone);
export const Sun = w(LSun);
export const Moon = w(LMoon);
export const MessageSquare = w(LMessageSquare);
export const Grid = w(LLayoutGrid);
export const CalendarClock = w(LCalendarClock);
export const Crown = w(LCrown);
export const Wrench = w(LWrench);
export const Gem = w(LGem);
export const AlertTriangle = w(LAlertTriangle);
export const Archive = w(LArchive);
export const Megaphone = w(LMegaphone);
export const BarChart = w(LBarChart);
export const Video = w(LVideo);
export const Calendar = w(LCalendar);
export const VolX = w(LVolumeX);
export const User = w(LUser);
export const Gamepad = w(LGamepad);
export const Clipboard = w(LClipboard);
export const BookOpen = w(LBookOpen);
export const ChevL = w(LChevL);
export const Palette = w(LPalette);
export const Mail = w(LMail);
export const Building2 = w(LBuilding2);
export const Smartphone = w(LSmartphone);
export const Landmark = w(LLandmark);
export const Wifi = w(LWifi);
export const WifiOff = w(LWifiOff);
...
export const I = {
  ...
  MessageSquare, Grid, CalendarClock, Phone, Sun, Moon,
  Crown, Wrench, Gem, AlertTriangle, Archive, Megaphone, BarChart,
  Video, Calendar, VolX, User, Gamepad, Clipboard, BookOpen, ChevL,
  Palette, Mail, Building2, Smartphone, Landmark, Wifi, WifiOff,
};
