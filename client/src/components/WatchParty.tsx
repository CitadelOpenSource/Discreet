      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 16, gap: 12 }}>
          ...
          {!session ? (
            /* ── Setup panel ── */
            <div style={{
              background: T.sf, borderRadius: 12, border: `1px solid ${T.bd}`,
        ...
        <div style={{
          ...
          {session ? (
            <>
              ...
              {!isHost && (
                <div style={{ marginTop: 'auto', padding: '8px 10px', background: T.sf2, borderRadius: 8, fontSize: 11, color: T.mt, lineHeight: 1.5 }}>
