  ...
  return (
    <Modal title="Settings" onClose={onClose} wide>
      {!s ? <div style={{ color: T.mt, textAlign: 'center', padding: 20 }}>Loading settings...</div> : (<>
        ...
        {/* ── Account ── */}
        {tab === 'account' && (<Suspense fallback={<div style={{ color: T.mt, textAlign: 'center', padding: 20, fontSize: 12 }}>Loading...</div>}><SettingsAccount s={s} save={save} sectionVisible={sectionVisible} onUpgrade={onUpgrade} platformUser={platformUser} SecurityStatus={SecurityStatus} ChangeEmail={ChangeEmail} ChangePassword={ChangePassword} ActiveSessions={ActiveSessions} RotateEncryptionKey={RotateEncryptionKey} ClearLocalCache={ClearLocalCache} DeleteAccount={DeleteAccount} /></Suspense>)}
