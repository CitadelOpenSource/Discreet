...
export function CtxMenu({ x, y, items, onClose }: CtxMenuProps) {
  ...
  return ReactDOM.createPortal(
    <div ref={ref} style={{
      ...
      minWidth: 200, background: '#111320', borderRadius: 8,
        ...
        return (
          <div key={i} style={{ position: 'relative' }}>
            ...
            >
              ...
              {it.hint && <span style={{ fontSize: 10, color: T.mt, fontFamily: "'JetBrains Mono',monospace" }}>{it.hint}</span>}
            </div>
            {subOpen === i && hasSub && (
              <div
                style={{
                  position: 'absolute', left: '100%', top: 0, minWidth: 180,
                  background: '#111320', borderRadius: 8, border: '1px solid ' + T.bd,
                  padding: '5px 0', boxShadow: '0 8px 32px rgba(0,0,0,0.6)', zIndex: 10002,
                }}
