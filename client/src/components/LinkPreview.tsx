...
function OgCard({ url }: { url: string }) {
  ...
  return (
    <div style={{ marginTop: 6, maxWidth: 420, borderRadius: 'var(--radius-md)', overflow: 'hidden', border: `1px solid ${T.bd}`, background: T.sf2, display: 'flex' }}>
      {og.image && (
        <img
          src={og.image}
          alt=""
...
function UrlCard({ url }: { url: string }) {
  ...
  if (ytMatch) {
    return (
      <div style={{ marginTop: 6, maxWidth: 400, borderRadius: 'var(--radius-md)', overflow: 'hidden', border: `1px solid ${T.bd}`, background: T.sf2 }}>
        <iframe
  ...
  if (twitchMatch) {
    return (
      <div style={{ marginTop: 6, maxWidth: 400, borderRadius: 'var(--radius-md)', overflow: 'hidden', border: `1px solid ${T.bd}`, background: T.sf2, padding: '8px 12px' }}>
