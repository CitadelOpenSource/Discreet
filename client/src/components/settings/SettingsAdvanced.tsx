...
export default function SettingsAdvanced({ sel, curServer, DevTools }: SettingsAdvancedProps) {
  return (<>
    ...
    <div style={{ fontSize: 11, color: (T as any).warn, marginBottom: 12, padding: '8px 12px', background: 'rgba(250,166,26,0.08)', borderRadius: 8, border: '1px solid rgba(250,166,26,0.15)' }}>Warning: Power user settings. Incorrect changes may affect performance.</div>
