...
function SecretModal({ name, secret, onClose }: { name: string; secret: string; onClose: () => void }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: T.sf, borderRadius: 'var(--border-radius)', padding: 24, maxWidth: 480, width: '90%',
  ...
  return (
    <div style={{
      ...
      <select
        ...
        style={{
          width: '100%', padding: '8px 12px', background: T.bg,
          border: `1px solid ${T.bd}`, borderRadius: 'var(--radius-md)', color: channelId ? T.tx : T.mt,
          fontSize: 13, outline: 'none', boxSizing: 'border-box', marginBottom: 10,
        }}
...
function WebhookRow({
  ...
  return (
    <div style={{
      padding: '10px 12px', background: T.sf2, borderRadius: 'var(--radius-md)',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div
          ...
          style={{
            ...
            background: webhook.enabled ? T.ac : T.bd,
