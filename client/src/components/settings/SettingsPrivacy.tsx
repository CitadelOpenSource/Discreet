...
export default function SettingsPrivacy({ s, save, sel, sectionVisible }: SettingsPrivacyProps) {
  ...
  return (<>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 20 }}>
      ...
      <div><label style={{ fontSize: 12, color: T.mt, marginBottom: 4, display: 'block' }}>{t('status.setStatus')}</label>
    ...
    <div style={{ padding: '12px 14px', background: T.sf2, borderRadius: 'var(--radius-md)', border: `1px solid ${T.bd}`, marginBottom: 10 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        }} style={{ width: 36, height: 20, borderRadius: 10, background: s.friends_only_mode === true ? T.ac : T.bd, cursor: 'pointer', position: 'relative', transition: 'background 0.2s', flexShrink: 0 }}>
          <div style={{ width: 16, height: 16, borderRadius: 'var(--radius-md)', background: '#fff', position: 'absolute', top: 2, left: s.friends_only_mode === true ? 18 : 2, transition: 'left 0.2s' }} />
        </div>
      </div>
    ...
    <div style={{ padding: '12px 14px', background: T.sf2, borderRadius: 'var(--radius-md)', border: `1px solid ${T.bd}`, marginBottom: 10 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        }} style={{ width: 36, height: 20, borderRadius: 10, background: s.ai_disabled === true ? T.err : T.bd, cursor: 'pointer', position: 'relative', transition: 'background 0.2s', flexShrink: 0 }}>
          <div style={{ width: 16, height: 16, borderRadius: 'var(--radius-md)', background: '#fff', position: 'absolute', top: 2, left: s.ai_disabled === true ? 18 : 2, transition: 'left 0.2s' }} />
        </div>
      </div>
      {s.ai_disabled === true && (
        <div style={{ marginTop: 8, padding: '8px 10px', background: T.bg, borderRadius: 6, fontSize: 11, color: T.err, lineHeight: 1.5 }}>
