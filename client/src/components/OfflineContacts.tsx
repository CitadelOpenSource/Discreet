        ...
        <div key={c.user_id} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 12px', marginBottom: 6, background: T.sf2, borderRadius: 10, border: `1px solid ${T.bd}` }}>
          ...
          {c.friend_request_sent ? (
            ...
            <button
              ...
              style={{ padding: '4px 12px', fontSize: 11, fontWeight: 700, borderRadius: 'var(--radius-md)', cursor: 'pointer', background: T.ac, color: '#000', border: 'none', opacity: sending === c.user_id ? 0.6 : 1, flexShrink: 0 }}
            >
