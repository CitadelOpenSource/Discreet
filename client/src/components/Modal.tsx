...
interface ModalProps {
  ...
  wide?: boolean;
  extraWide?: boolean;
  /** Override the computed width (px). Takes precedence over wide/extraWide. */
...
export function Modal({ title, onClose, children, wide, extraWide, widthOverride, ...rest }: ModalProps) {
  ...
  return (
    ...
    >
      <div
        ...
        {...rest}
        style={{
          width: widthOverride || (extraWide ? 700 : wide ? 560 : 420), maxWidth: '95vw', padding: 28,
          background: T.sf, borderRadius: 16, border: `1px solid ${T.bd}`,
          maxHeight: widthOverride ? '92vh' : extraWide ? '92vh' : '85vh', overflowY: 'auto',
