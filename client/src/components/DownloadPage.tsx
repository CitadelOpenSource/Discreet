...
function useS() {
  ...
  return {
    ...
    card: (available: boolean) => ({
      padding: '20px', background: C.sf2, borderRadius: 12, border: `1px solid ${C.bd}`,
    ...
    code: { display: 'block', padding: '12px 14px', background: C.bg, borderRadius: 8, border: `1px solid ${C.bd}`, fontFamily: "'JetBrains Mono', monospace", fontSize: 12, color: C.ac, overflowX: 'auto' as const, marginBottom: 8 } as React.CSSProperties,
