...
function StepLayout({ selected, onSelect }: { selected: string; onSelect: (l: string) => void }) {
  const layouts = [
    { id: 'simple', name: 'Simple', desc: 'Clean and minimal. Only essential buttons. Perfect for casual chatting.', Icon: LayoutIconChat },
    { id: 'standard', name: 'Standard', desc: 'Full sidebar, action buttons, keyboard shortcuts. The Discord experience.', Icon: LayoutIconSliders },
    { id: 'power', name: 'Power', desc: 'Everything visible. Dev tools, connection stats, audit log access.', Icon: LayoutIconTerminal },
  ];
