...
function S() {
  ...
  return {
    ...
    canary: { padding: '24px 28px', background: 'rgba(0,212,170,0.04)', border: '1px solid rgba(0,212,170,0.15)', borderRadius: 12, marginBottom: 32 } as React.CSSProperties,
    ...
    notice: { fontSize: 13, color: C.mt, lineHeight: 1.7, marginTop: 24, padding: '16px 20px', background: 'rgba(250,166,26,0.06)', border: '1px solid rgba(250,166,26,0.15)', borderRadius: 8 } as React.CSSProperties,
