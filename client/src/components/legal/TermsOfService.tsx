...
function useS() {
  ...
  return {
    ...
    warn: { padding: '14px 16px', background: 'rgba(255,71,87,0.06)', border: '1px solid rgba(255,71,87,0.2)', borderRadius: 'var(--radius-md)', marginBottom: 12, fontSize: 14, color: '#ff4757', lineHeight: 1.6 } as React.CSSProperties,
    ac: C.ac, mt: C.mt,
  };
}
