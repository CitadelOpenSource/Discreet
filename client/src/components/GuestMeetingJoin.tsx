...
export function GuestMeetingJoin({ code }: { code: string }) {
  ...
  if (phase === 'join') {
    return (
      <div style={{ minHeight: '100vh', background: C.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-primary)', padding: 24 }}>
          ...
          <div style={{ padding: '20px 24px', borderBottom: `1px solid ${C.bd}`, display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: C.mt }}>
                Code: <span style={{ fontFamily: 'var(--font-mono)', color: C.ac, fontWeight: 700, letterSpacing: 2 }}>{formattedCode}</span>
              </div>
            </div>
          </div>
  ...
  if (phase === 'waiting') {
    return (
      <div style={{ minHeight: '100vh', background: C.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-primary)' }}>
        <div style={{ textAlign: 'center', maxWidth: 360, padding: 24 }}>
          ...
          <div style={{ fontSize: 13, color: C.mt, lineHeight: 1.7, marginBottom: 28 }}>
            ...
            <span style={{ color: C.ac, fontFamily: 'var(--font-mono)', fontWeight: 700 }}>{formattedCode}</span>
            {' '}has been sent.<br />
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', background: '#0a0c14', fontFamily: 'var(--font-primary)' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          letterSpacing: 3, fontFamily: 'var(--font-mono)',
        }}>
          {formattedCode}
        </div>
      </div>
