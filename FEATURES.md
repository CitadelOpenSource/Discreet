...
| Feature | Details | Status |
|---------|---------|--------|
| React Native app | iOS + Android | 🔜 Waves M-R |
| BLE proximity mesh | Device-to-device, zero internet | 🔜 Wave Q |
| X25519 key exchange | 4-emoji SAS verification | 🔜 Wave Q |
| Multi-hop relay | 3 hops, 5min TTL, encrypted relay | 🔜 Wave Q |
| Wi-Fi Direct voice | Zero-internet voice calls | 🔜 Wave Q |
| Push notifications | FCM + APNs | 🔜 Wave P |
| Biometric unlock | Face ID, fingerprint | 🔜 Wave P |
| Offline queue | Local SQLite message buffer | 🔜 Wave P |
...
| Feature | Details | Status |
|---------|---------|--------|
| Tauri wrapper | Lightweight native app from web client | 🔜 Prompts D1-D2 |
