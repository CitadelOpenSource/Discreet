...
--
-- Brings the database in sync with the Codex Wave 1-3 handler code.
-- All statements are idempotent (IF NOT EXISTS / ADD COLUMN IF NOT EXISTS)
-- so this migration is safe to run on any database state.
--
-- Root cause: Codex appended new tables to 001_schema.sql and the handler
-- code references columns/tables that were never applied to existing DBs.

-- ═══════════════════════════════════════════════════════════════════════
-- 1. SERVERS TABLE — add missing columns from Wave 2-3
-- ═══════════════════════════════════════════════════════════════════════
