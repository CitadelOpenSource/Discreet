...
| Before | After | Why |
|--------|-------|-----|
| PBKDF2-SHA256 (100k iterations) | HKDF-SHA256 | HKDF is the correct KDF for key derivation from high-entropy input; PBKDF2 is for password stretching |
| Raw SHA-256 for agent keys | HKDF with domain separation | Proper key derivation with salt `discreet-agent-v1` |
