...
function Toggle({ label, value, onChange }: { label: string; value: boolean; onChange: (v: boolean) => void }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer' }} onClick={() => onChange(!value)}>
      <div style={{ width: 30, height: 16, borderRadius: 8, background: value ? T.ac : T.sf2, border: `1px solid ${T.bd}`, position: 'relative', transition: 'background .2s', flexShrink: 0 }}>
  ...
  return (
    <div style={{ flex: 1, display: 'flex', height: '100%', overflow: 'hidden', background: T.bg }}>
      ...
      {showForm && (
        ...
        >
          <div style={{ background: T.sf, border: `1px solid ${T.bd}`, borderRadius: 12, padding: 24, width: 460, maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            {form.scheduleMeeting && (
              <div style={{ background: 'rgba(88,101,242,0.08)', border: '1px solid #5865f244', borderRadius: 8, padding: '8px 12px', marginBottom: 14, fontSize: 12, color: '#7984f5' }}>
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end', marginTop: 4 }}>
              <button onClick={() => setShowForm(false)} style={{ padding: '8px 16px', background: T.sf2, color: T.mt, border: `1px solid ${T.bd}`, borderRadius: 8, cursor: 'pointer', fontSize: 13 }}>Cancel</button>
      ...
      {reminderPrompt && (
        ...
        >
          <div style={{ background: T.sf, border: `1px solid ${T.bd}`, borderRadius: 12, padding: 20, width: 320 }}>
      ...
      {showReminders && (
        ...
        >
          <div style={{ background: T.sf, border: `1px solid ${T.bd}`, borderRadius: 12, padding: 24, width: 400, maxHeight: '70vh', overflowY: 'auto' }}>
