// discreet_agent_types.rs — Data types for the AI Agent Framework.
//
// Defines the core structures for auto-spawning specialist AI agents
// that participate as MLS group members in E2EE channels.
//
// This file contains types only. Handlers are in discreet_agent_handlers.rs.
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub enum LLMBackend {
    /// Discreet-managed cloud inference (Pro tier).
    DiscreetCloud { endpoint: String, api_version: String },
