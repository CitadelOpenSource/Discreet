// citadel_category_handlers.rs — community-style channel categories.
//
...
use crate::citadel_permissions::{require_permission, PERM_MANAGE_CHANNELS, PERM_VIEW_CHANNEL};
