// citadel_federation.rs — Federation protocol for Citadel-to-Citadel communication.
//
...
//
// Discovery: GET /.well-known/citadel-federation
...
/// Served at GET /.well-known/citadel-federation
#[derive(Debug, Clone, Serialize, Deserialize)]
